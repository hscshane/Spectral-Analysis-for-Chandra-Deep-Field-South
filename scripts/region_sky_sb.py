...
file = 'CDFS4MS_sb.fits'
hdulist = fits.open(file)
tbdata = hdulist[1].data
for i in range(0,739):
  chandra_ra.append(float(tbdata[i]['RA']))
  chandra_dec.append(float(tbdata[i]['DEC']))
  chandra_flux.append(abs(float(tbdata[i]['SB_FLUX'])))
